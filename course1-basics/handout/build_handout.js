...
children.push(body([
  t("오늘 배운 기초 위에서, 가장 빠른 실전 이득부터 챙깁니다. 다음은 "),
  t("C2 — 업무 자동화로 생산성 향상 (초급)", { bold: true, color: CORAL }),
  t("입니다. 매주 반복하는 업무 하나를 나만의 하네스로 자동화하고, 결과를 PPT·Word·Excel·PDF로 자동 생성하는 법을 배웁니다."),
]));
